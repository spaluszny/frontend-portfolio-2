        ...
        <div className="max-w-screen-2xl mx-auto">
            ...
            <div className="grid grid-rows-2 lg:grid-rows-1 lg:grid-cols-2 lg:h-screen gap-20 ">
                <div className="flex flex-col justify-center items-center lg:pl-20 p-5 max-w-150 md:pt-40 lg:max-w-200 mx-auto">
                    ...
                    <p className="text-base md:text-lg font-sans"> I'm a frontend developer passionate about usablity and design.
                        Having built my web
                        ...
                        <br></br>
                    <p className="text-base md:text-lg font-sans text-left">
                        In my free time I like to travel, cook, read. I'm currently reading book thief right now
                    </p>
