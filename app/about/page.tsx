...
export default function Home() {
    return (
        ...
        <div className="max-w-screen-2xl mx-auto">
            ...
            <div className="grid grid-rows-2 md:grid-rows-1 md:grid-cols-2 md:h-screen gap-20 ">
                <div className="flex flex-col justify-center items-center md:pl-20 h-screen p-5">
                    ...
                    <div className="w-full pt-10 flex flex-row gap-5">
                        ...
                        <Link href={siteConfig.links.github} target="_blank" rel="noreferrer">
                            <Icons.gitHub className="h-8 hover:text-gray-600 transform transition duration-300 hover:scale-110" />
                            <span className="sr-only">LinkedIn</span>
                        </Link>
                        <Link href={siteConfig.links.linkedIn} target="_blank" rel="noreferrer">
                            <Icons.linkedin className="h-8 hover:text-gray-600 transform transition duration-300 hover:scale-110" />
                            <span className="sr-only">GitHub</span>
                        </Link>
                        <Link href={siteConfig.links.leetCode} target="_blank" rel="noreferrer">
                            <Icons.leetCode className="h-8 hover:text-gray-600 transform transition duration-300 hover:scale-110" />
